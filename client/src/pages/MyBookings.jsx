...
const MyBookings = () => {
  ...
  return (
    ...
    className='px-6 md:mx-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <div>
        {
          bookings.map((booking,index) => (
            ...
            className='grid grid-cols1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12' key={index}>
              {/* Car Image + Info */}
