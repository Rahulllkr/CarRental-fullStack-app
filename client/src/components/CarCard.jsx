        ...
        <div className='p-4 sm:p-5 relative'>
            ...
            <div className='flex justify-between items-start mb-2'>
                <div>
                    ...
                    <p className='text-muted-foreground text-sm'>{car.category} •́ {car.year}</p>
                </div>
            </div>
            ...
            <div className='absolute top-4 right-4 bg-black backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
